...
<a href="https://www.paypal.com/donate/?business=PSZ878JBJDMB8&amount=10&no_recurring=0&item_name=Thankyou+for+your+support+in+maintaining+this+project&currency_code=AUD">
  <img src="https://github.com/antoinet/Guacamole-Installer/raw/main/.github/ISSUE_TEMPLATE/paypal-donate-button.png" width="125" />
</a>
</p>
...
```shell
wget https://raw.githubusercontent.com/antoinet/Guacamole-Installer/main/1-setup.sh && chmod +x 1-setup.sh && ./1-setup.sh
```
...
🔑 **Need help with Active Directory integration & SSO authentication?** Check [here](https://github.com/antoinet/Guacamole-Installer/blob/main/ACTIVE-DIRECTORY-HOW-TO.md).
...
- **For a separate DATABASE layer:** Use the `install-mysql-backend-only.sh` [here](https://github.com/antoinet/Guacamole-Installer/tree/main/guac-enterprise-build) to install a standalone instance of the Guacamole MySQL database.
